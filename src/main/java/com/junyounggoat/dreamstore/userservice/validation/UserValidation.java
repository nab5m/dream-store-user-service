...
public abstract class UserValidation {
    ...
    public @interface UserPersonName {
        String message() default USER_PERSON_NAME_MIN_LENGTH + "~" + USER_PERSON_NAME_MAX_LENGTH + "자의 이름을 입력해주세요.";
        Class<?>[] groups() default {};
        Class<? extends Payload>[] payload() default {};
    }
    ...
    public @interface UserEmailAddress {
        String message() default USER_EMAIL_ADDRESS_MAX_LENGTH + "자 이하의 이메일 주소를 입력해주세요.";
        Class<?>[] groups() default {};
        Class<? extends Payload>[] payload() default {};
    }
    ...
    public @interface UserPhoneNumber {
        String message() default USER_PHONE_NUMBER_MIN_LENGTH + "~" + USER_PHONE_NUMBER_MAX_LENGTH + "자의 휴대폰 번호를 입력해주세요.";
        Class<?>[] groups() default {};
        Class<? extends Payload>[] payload() default {};
    }
