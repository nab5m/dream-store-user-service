...
abstract class DocumentMessages {
    ...
    public static final String USER_BIRTH_DATE_DESCRIPTION = "<h3>사용자생년월일</h3>" +
            UserValidation.USER_BIRTH_DATE_ERROR_MESSAGE;
}
