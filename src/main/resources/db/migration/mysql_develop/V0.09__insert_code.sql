...
SELECT @CODE_CATEGORY_LOGIN_CATEGORY_ID := code_category_id FROM `code_category`
    WHERE code_category_name = @CODE_CATEGORY_LOGIN_CATEGORY_NAME;

SELECT @CODE_CATEGORY_USER_AGREEMENT_ID := code_category_id FROM `code_category`
    WHERE code_category_name = @CODE_CATEGORY_USER_AGREEMENT_NAME;

SELECT @CODE_CATEGORY_GENDER_ID := code_category_id FROM `code_category`
    WHERE code_category_name = @CODE_CATEGORY_GENDER_NAME;

SELECT @CODE_CATEGORY_USER_PRIVACY_USAGE_PERIOD_ID := code_category_id FROM `code_category`
...
SELECT @CODE_GROUP_REQUIRED_USER_AGREEMENT_ID := code_group_id FROM `code_group`
    WHERE code_group_name = @CODE_GROUP_REQUIRED_USER_AGREEMENT_NAME;

SELECT @CODE_ITEM_REQUIRED_PRIVACY_COLLECTION_AGREEMENT_ID := code_item_id FROM `code_item`
    WHERE code_name = @CODE_ITEM_REQUIRED_PRIVACY_COLLECTION_AGREEMENT_NAME;
SELECT @CODE_ITEM_TERMS_OF_SERVICE_ID := code_item_id FROM `code_item`
