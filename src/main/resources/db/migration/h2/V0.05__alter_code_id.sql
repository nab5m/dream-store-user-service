...
ALTER TABLE `user`
    ALTER COLUMN user_nonmember_flag BOOLEAN NOT NULL;
...
ALTER TABLE `user`
    ALTER COLUMN user_gender_code int;
...
ALTER TABLE `user_login_category`
    ALTER COLUMN user_login_category_code int NOT NULL;
...
ALTER TABLE `user_agreement_item`
    ALTER COLUMN user_agreement_item_code int NOT NULL;
...
ALTER TABLE `user_login_block_period`
    ALTER COLUMN user_login_block_reason_code int NOT NULL;
...
ALTER TABLE `address`
    ALTER COLUMN eupmyeondong_code int NOT NULL;

ALTER TABLE `address`
    ALTER COLUMN sido_code int NOT NULL;

ALTER TABLE `address`
    ALTER COLUMN sigungu_code int NOT NULL;
...
ALTER TABLE `code_group_item`
    RENAME CONSTRAINT code_id TO code_item_id;
