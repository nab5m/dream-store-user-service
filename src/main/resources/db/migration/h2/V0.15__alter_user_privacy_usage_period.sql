...
UPDATE `user_privacy_usage_period`
	SET `usage_end_date_time` = CASE user_privacy_usage_period_code
            ...
            WHEN 31536000
            THEN DATEADD(YEAR, 1, usage_start_date_time)
            WHEN 94608000
            THEN DATEADD(YEAR, 3, usage_start_date_time)
            WHEN 157680000
            THEN DATEADD(YEAR, 5, usage_start_date_time)
            ELSE DATEADD(SECOND, user_privacy_usage_period_code, usage_start_date_time)
		END
